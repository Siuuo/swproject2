...
#define _DUTY_MAX 2407 // servo full counterclockwise position (180 degree)
...
void loop() {
  ...
  else if (_TARGET_LOW < dist_raw < _TARGET_HIGH) {
    myservo.writeMicroseconds(_DUTY_MIN+10.3*(dist_raw-_TARGET_LOW));
    delay(300);
  }
